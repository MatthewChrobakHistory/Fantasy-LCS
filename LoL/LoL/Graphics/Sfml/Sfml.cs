using LoL.Data;
using LoL.Graphics.Sfml.Scenes;
using SFML.Graphics;
using SFML.Window;
using System.Collections.Generic;
using System.IO;

namespace LoL.Graphics.Sfml
{
    public class Sfml : IGraphics
    {
        ...
        public Sfml() {
            ...
            this.DrawingSurface = new RenderWindow(new VideoMode(1080, 675), "League of Legends", Styles.Close);

            // Set the default background color for the drawing surface.
            this._backgroundColor = new Color(0, 22, 27);
        ...
        private void CreateEventHandlers() {
            ...
            this.DrawingSurface.Closed += DrawingSurface_Closed;
        }
